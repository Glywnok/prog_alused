...
z = int(input("Sisestage mitu inimest kokku võib istuda bussil ilma bussijuht: "))
...
if c > 0:
    print("Kokku on " + str(x) + " inimest ja " + str(y) + " bussi. Kokku ühes bussis võib istuda " + str(z) + " inimest. Kokku bussi saab " + str(saab_sisse) + "inimest ilma bussijuthi ja " + str(c) + " inimest saab ära jääda.")
else:
    print("Kokku on " + str(x) + " inimest ja " + str(y) + " bussi. Kokku ühes bussis võib istuda " + str(z) + " inimest. Kokku bussi saab " + str(saab_sisse) + "inimest ilma bussijuthi ja mitte keegi ei jää ära!")